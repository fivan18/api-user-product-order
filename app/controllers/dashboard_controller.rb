class DashboardController < ApplicationController
    ...
    def index
      ...
      quantities = Quantity.group(:product_id).sum(:quantity)
      ...
      render json: { users: users, products: products, most_sale_products: most_sale_products, orders_per_month: orders_per_month }
    end
  end